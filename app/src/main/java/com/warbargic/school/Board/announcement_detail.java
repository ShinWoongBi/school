...
/**
 * Created by kippe_000 on 2017-05-27.
 */
...
//                startActivity(new Intent(DownloadManager.ACTION_VIEW_DOWNLOADS));
        ...
        Get_announcement_detail get_announcement_detail = new Get_announcement_detail();
        get_announcement_detail.execute();
    ...
    class Get_announcement_detail extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try{
                url = new URL("http://tlsdndql27.vps.phps.kr/taereung_school/get_announcement_detail.php");
